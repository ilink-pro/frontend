...
export class CreateVerificationEntities1653087230097 implements MigrationInterface {
  name = 'CreateVerificationEntities1653087230097'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "address_document_entity" ("id" uuid NOT NULL, "file" bytea NOT NULL, "applicantId" uuid, CONSTRAINT "PK_7d6c3adaa6b046d487e27901e84" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TYPE "public"."id_document_entity_type_enum" AS ENUM('PASSPORT', 'ID_CARD', 'RESIDENCE_PERMIT')`
    )
    await queryRunner.query(
      `CREATE TABLE "id_document_entity" ("id" uuid NOT NULL, "type" "public"."id_document_entity_type_enum" NOT NULL DEFAULT 'PASSPORT', "frontSide" bytea NOT NULL, "backSide" bytea NOT NULL, CONSTRAINT "PK_e50fc9dcc3eeeb458bcf67f66ae" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
