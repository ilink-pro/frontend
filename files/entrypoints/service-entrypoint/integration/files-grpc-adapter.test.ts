...
import { FilesServiceClientModule }            from '@files/files-service-proto'
import { FILES_SERVICE_CLIENT_TOKEN }          from '@files/files-service-proto'
import { FilesServiceClient }                  from '@files/files-service-proto'
